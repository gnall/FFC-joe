package washo.gmd.app.client.local.page.gameView;
/*
 * #%L
 * GwtMaterial
 * %%
...
@Templated
@ApplicationScoped
@org.jboss.errai.ui.nav.client.local.Page(path = "game/{gameID}")
public class GamePage extends Page implements HasNavigation {
    ...
    public void onPostConstruct() {
    	...
    	GWT.log("THIS IS THE GAME ID ON GAME PAGE: "+gameID);
